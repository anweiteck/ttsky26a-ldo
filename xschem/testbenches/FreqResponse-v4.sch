...
N 1110 -70 1110 -10 {lab=VOUT}
N -250 -220 -180 -220 {lab=#net6}
...
N -140 -80 -140 -60 {lab=#net7}
N -290 -80 -290 20 {lab=GND}
N -140 -190 -140 -140 {lab=#net6}
N -250 -110 -180 -110 {lab=#net8}
N -290 -190 -290 -140 {lab=#net8}
N -230 -150 -230 -110 {lab=#net8}
N -290 -150 -230 -150 {lab=#net8}
N -190 -220 -190 -180 {lab=#net6}
N -190 -180 -140 -180 {lab=#net6}
N -140 -260 -120 -260 {lab=VDD}
N -120 -260 -120 -230 {lab=VDD}
N -320 -260 -290 -260 {lab=VDD}
N -140 -70 -120 -70 {lab=#net7}
N -310 -110 -310 -70 {lab=GND}
N -310 -70 -290 -70 {lab=GND}
N -60 -220 -60 -210 {lab=#net6}
N -180 -220 -180 -210 {lab=#net6}
N -20 -190 -20 -180 {lab=#net4}
N -140 -110 -120 -110 {lab=#net7}
N -120 -110 -120 -70 {lab=#net7}
...
N -180 -210 -60 -210 {lab=#net6}
N -20 -180 -20 40 {lab=#net4}
N -140 -270 -20 -270 {lab=VDD}
...
N 430 -50 580 -50 {lab=v+}
N 640 -50 960 -50 {lab=#net5}
N 530 -50 530 -40 {lab=v+}
C {ipin.sym} 370 -280 1 0 {name=p6 lab=VDD}
C {vsource.sym} 140 -20 0 0 {name=V3 value=0.6 savecurrent=false}
...
C {code.sym} -510 220 0 0 {name=s1 only_toplevel=false 
value= "
...
*plot vout
plot db(vout/v(v+)) 
plot 180*cph(vout)/pi+360
.endc
"}
C {vsource.sym} -300 280 0 0 {name=V1 value=1.8 savecurrent=false}
C {ipin.sym} -300 250 1 0 {name=p5 lab=VDD}
C {ipin.sym} -300 310 3 0 {name=p10 lab=GND}
C {vsource.sym} 530 50 0 0 {name=V2 value="0 AC 1m" savecurrent=false}
C {res.sym} 1030 0 0 0 {name=R2
value=20
footprint=1206
device=resistor
m=1}
C {gnd.sym} 530 80 0 0 {name=l1 lab=GND}
C {capa.sym} 1110 20 0 0 {name=C1
m=1
value=10p
footprint=1206
device="ceramic capacitor"}
C {sky130_fd_pr/pfet_01v8_lvt.sym} -160 -220 0 0 {name=M2
W=1
L=1
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} -270 -220 0 1 {name=M3
W=1
L=1
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} -40 -220 0 0 {name=M4
W=1
L=1
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} -270 -110 0 1 {name=M6
W=2
L=1
nf=1
mult=1
...
C {sky130_fd_pr/res_high_po_0p35.sym} -140 -30 0 0 {name=R5
L=3.1
model=res_high_po_0p35
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_high_po_0p35.sym} 960 -110 0 0 {name=R6
L=35.7
model=res_high_po_0p35
spiceprefix=X
mult=1}
C {sky130_fd_pr/res_high_po_0p35.sym} 960 70 0 0 {name=R7
L=53.9
model=res_high_po_0p35
spiceprefix=X
mult=1}
C {sky130_fd_pr/cap_mim_m3_1.sym} 530 -150 1 0 {name=C4 model=cap_mim_m3_1 W=50 L=50 MF=1 spiceprefix=X}
C {ind.sym} 610 -50 1 0 {name=L2
m=1
value=1
footprint=1206
device=inductor}
C {capa.sym} 530 -10 0 0 {name=C2
m=1
value=1
footprint=1206
device="ceramic capacitor"}
